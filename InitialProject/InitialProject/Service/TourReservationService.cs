...
namespace InitialProject.Service
{
    public class TourReservationService
    {
        ...
        public int GetNumberOfGuests(int tourId)
        {
            return _tourReservationRepository.GetNumberOfGuests(tourId);
        }
        ...
        // public double GetAverageReviewsFor(Tour tour)
        // {
        //     List<TourReservation> reservations = GetByTour(tour);
        //     double total  = 0;
        //     foreach (TourReservation reservation in reservations)
        //     {
        //         total += tourReviewService.GetSingleAverage(reservation);
        //     }
        //
        //     return total;
        // }
