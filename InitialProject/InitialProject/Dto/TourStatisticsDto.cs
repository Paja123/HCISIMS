...
public class TourStatisticsDto
{
    ...
    public string WithVouchersString { get; set; }
    public string WithoutVouchersString { get; set; }
    ...
    private void SetPercentage(int totalGuests, int withVouchers)
    {
        ...
        WithVouchersString = WithVouchers + "%";
        WithoutVouchersString = WithVouchersString + "%";
    }
